...
function injectIntoMonit(conf, apps){
    ...
    fs.readFile(conf, function(err, data){
        if(err) {
            ...
            content.replace(/### Automatically generated by Theorem ###[^]+### End of Theorem Config ###/, '### Automatically generated by Theorem ###\n\n' + theoremConf + '### End of Theorem Config ##');
...
function injectIntoSupervisor(conf, apps){
    var deferred = Q.defer();
...
module.exports = function(program) {
	...
	program
		...
		.action(function(/* Args here */){
            ...
            Q.when(injectIntoMonit(monitConf, apps), injectIntoSupervisor(supervisorConf, apps)).fail(function(err){
